    ...
    return BlocBuilder<AppCubit, AppState>(
      builder: (context, state) {
        return GridView.builder(
          ...
          itemCount:
              AppCubit.get(context).allServiceList.length,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: AppText(
                            ...
                            top: 10.h,
                            text:
                                AppCubit.get(context).allServiceList[index].title,
                            size: 12.sp,
                        ...
                        SizedBox(
                          ...
                          child: AppText(
                            ...
                            start: 10.w,
                            top: 3.h,
                            text: AppCubit.get(context).allServiceList[index].sectionTitle,
                    ...
                    AppCachedImage(
                      image: AppCubit.get(context).allServiceList[index].firstImage ,
                      fit: BoxFit.cover,
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
